...
import io.edgarcode.timeselector.Utils.TextUtil;
import io.edgarcode.timeselector.view.PickerView;
...
public class TimeSelector {
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        ...
        initDialog();
        initView();
        setScrollUnit(TimeSelector.SCROLLTYPE.YEAR, TimeSelector.SCROLLTYPE.MONTH, TimeSelector.SCROLLTYPE.DAY, TimeSelector.SCROLLTYPE.HOUR, TimeSelector.SCROLLTYPE.MINUTE);
    }
    ...
    private void initView() {
        ...
        TextView tv_title = (TextView) seletorDialog.findViewById(R.id.tv_title);
        ...
        year_pv.setColor(color);
        month_pv.setColor(color);
        day_pv.setColor(color);
        hour_pv.setColor(color);
        minute_pv.setColor(color);

        tv_cancle.setTextColor(Color.BLACK);
